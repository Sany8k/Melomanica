...
export default function AutoSkip(): JSX.Element {
  ...
  const handleDeleteRule = (id: string, indexToRemove: number) => {
    ...
    setRules(newRules); chrome.storage.local.set({ skipRules: newRules });
  };
